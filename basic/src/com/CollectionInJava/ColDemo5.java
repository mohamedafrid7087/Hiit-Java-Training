...
//		Set<Question> questionSet=new TreeSet<>(new MyQuestionComparator());
	//	Set<Question> questionSet=new TreeSet<>((q1,q2)->{return q2.qid.compareTo(q1.qid);});// lambda expression 
		
	Set<Question> questionSet1=new TreeSet<>(new Comparator<Question>() { // inner class
		@Override
